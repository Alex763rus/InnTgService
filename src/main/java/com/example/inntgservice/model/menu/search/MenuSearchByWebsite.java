...
public class MenuSearchByWebsite extends MenuSearchBase {
    ...
    private final static String MENU_COMMAND = SEARCH_BY_WEBSITE;

    private final static String INPUT_TEXT = "Введите сайт:";
    private final static String DESCRIPTION = "Поиск по телефону";

    private final static State WAIT_STATE = WAIT_WEBSITE;
